...
from track_yourself.views import home, Login, register, login_auth, log_phys_data, log_workout, view_summary, register_auth, user_home, access_denied, logout, invalid_login, add_data, view_data_summary
